...
If regenerated with the updated rules, this release would differ:

- **Remove phantom**: PR #7343 in changelog but not found in commit range azure-dev-cli_1.23.13..azure-dev-cli_1.23.14 (phantom entry).
- **Remove phantom**: PR #7299 in changelog but not found in commit range azure-dev-cli_1.23.13..azure-dev-cli_1.23.14 (phantom entry).
...
- **Add PR link**: entry at line would get a `[[#N]]` reference
- **Add PR link**: entry at line would get a `[[#N]]` reference
- **Add PR link**: entry at line would get a `[[#N]]` reference
- **Add PR link**: entry at line would get a `[[#N]]` reference
- **Add PR link**: entry at line would get a `[[#N]]` reference
- **Add PR link**: entry at line would get a `[[#N]]` reference
- **Fix link type**: change `/issues/` to `/pull/` for PR #2743
- **Remove phantom**: PR #2743 in changelog but not found in commit range azure-dev-cli_1.23.12..azure-dev-cli_1.23.13 (phantom entry).
- **Remove phantom**: PR #7330 in changelog but not found in commit range azure-dev-cli_1.23.12..azure-dev-cli_1.23.13 (phantom entry).
...
- **Use last PR number**: Dual PR numbers detected: commit references #7223 and #7291. Changelog uses #7223 but should use #7291 (last = canonical).
...
- **Include borderline change**: Excluded commit #7213 matches borderline keyword "ux". New rules recommend including it.
...
- **Include borderline change**: Excluded commit #6939 matches borderline keyword "output". New rules recommend including it.
...
- **Include borderline change**: Excluded commit #6859 matches borderline keyword "prompt". New rules recommend including it.
...
- **Include borderline change**: Excluded commit #6778 matches borderline keyword "help text". New rules recommend including it.
...
- **Remove phantom**: PR #6698 in changelog but not found in commit range azure-dev-cli_1.23.3..azure-dev-cli_1.23.4 (phantom entry).
...
- **Include borderline change**: Excluded commit #6654 matches borderline keyword "error message". New rules recommend including it.
- **Include borderline change**: Excluded commit #6605 matches borderline keyword "prompt". New rules recommend including it.
...
- **Include borderline change**: Excluded commit #6583 matches borderline keyword "prompt". New rules recommend including it.
- **Include borderline change**: Excluded commit #6537 matches borderline keyword "prompt". New rules recommend including it.
...
- **Include borderline change**: Excluded commit #6368 matches borderline keyword "ux". New rules recommend including it.
- **Remove phantom**: PR #6444 in changelog but not found in commit range azure-dev-cli_1.22.5..azure-dev-cli_1.23.0 (phantom entry).
