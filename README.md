...
Learn more about running third-party code on [our DevHub](https://learn.microsoft.com/en-us/azure/developer/azure-developer-cli/azd-templates?tabs=csharp#guidelines-for-using-azd-templates)