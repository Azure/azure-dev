...
- [[3216]](https://github.com/Azure/azure-dev/pull/3216) Adds support for OneAuth on windows
...
- [[3434]](https://github.com/Azure/azure-dev/pull/3434) Fixes issues where `azd infra synth` doesn't generate auto-generate inputs
