...
func (a *infraDeleteAction) SetupFlags(
	...
	local.BoolVar(&a.purgeDelete, "purge", false, "Does not require confirmation before permanently deletes resources that are soft-deleted by default (for example, key vaults).")
}
