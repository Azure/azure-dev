	...
	subcommands: [
		...
		},
		{
			...
			options: [
				...
				{
					name: ['--template', '-t'],
					description: 'Initializes a new application from a template. You can use a Full URI, <owner>/<repository>, <repository> if it\'s part of the azure-samples organization, or a local directory path.',
					args: [
						{
							name: 'template',
