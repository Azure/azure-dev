...
APP_NAME="azd-int-registry"

# Define output directory
OUTPUT_DIR="$SCRIPT_DIR/bin"

# Define target directory in the user's home
TARGET_DIR="$HOME/.azd/extensions/azd.internal.registry"
...
APP_PATH="github.com/azure/azure-dev/cli/azd/extensions/azd.internal.registry/internal/cmd"
