<!-- Generated by 'azd deploy' (activity protocol) for bot {{.BotName}}. azd may replace this file on the next deploy for this bot; copy it elsewhere to keep manual edits. -->
