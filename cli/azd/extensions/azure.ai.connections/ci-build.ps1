...
$ldFlag = "-ldflags=-s -w -X azure.ai.connections/internal/cmd.Version=$Version -X azure.ai.connections/internal/cmd.Commit=$SourceVersion -X azure.ai.connections/internal/cmd.BuildDate=$(Get-Date -Format o) "
