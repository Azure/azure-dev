...
// carry the toolbox and skill vocabulary it was copied from -- 34 codes and 9
// operation names for resources this extension has no concept of -- which
// offered anyone looking for the right code a menu belonging to a different
// product.
