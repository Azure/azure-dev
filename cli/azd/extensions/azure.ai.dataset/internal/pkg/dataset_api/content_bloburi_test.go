...
// shape for the other -- and every entry is downloaded, because isSingleFile is
// reported true for a generated container as well and believing it wrote
// whichever entry sorted first as though it were the dataset.
func TestListDatasetContentStillListsAContainerURI(t *testing.T) {
	...
	assert.False(t, content.SingleFile)
