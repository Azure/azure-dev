...
// The callback form works with each YAML package used by the host and extension,
// and retains the calling decoder's strict-field checks. A package-specific Node
// signature was silently ignored by the production configuration loader.
