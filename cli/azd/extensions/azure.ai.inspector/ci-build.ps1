...
$ldFlag = "-ldflags=-s -w -X 'azureaiinspector/internal/version.Version=$Version' -X 'azureaiinspector/internal/version.Commit=$SourceVersion' -X 'azureaiinspector/internal/version.BuildDate=$(Get-Date -Format o)' "
