...
$ldFlag = "-ldflags=-s -w -X azure.ai.inspector/internal/cmd.Version=$Version -X azure.ai.inspector/internal/cmd.Commit=$SourceVersion -X azure.ai.inspector/internal/cmd.BuildDate=$(Get-Date -Format o) "
