...
$buildFlags += @(
    ...
    "-ldflags=-s -w -X azure.ai.latency/internal/cmd.Version=$Version -X azure.ai.latency/internal/cmd.Commit=$SourceVersion -X azure.ai.latency/internal/cmd.BuildDate=$(Get-Date -Format o) ",
    "-o=$OutputFileName"
)
