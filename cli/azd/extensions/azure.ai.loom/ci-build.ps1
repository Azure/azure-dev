...
$buildFlags += @(
    ...
    "-ldflags=-s -w -X azure.ai.loom/internal/cmd.Version=$Version -X azure.ai.loom/internal/cmd.Commit=$SourceVersion -X azure.ai.loom/internal/cmd.BuildDate=$(Get-Date -Format o) ",
    "-o=$OutputFileName"
)
