...
$ldFlag = "-ldflags=-s -w -X azure.ai.routines/internal/cmd.Version=$Version -X azure.ai.routines/internal/cmd.Commit=$SourceVersion -X azure.ai.routines/internal/cmd.BuildDate=$(Get-Date -Format o) "
