...
// Package exterrors provides structured error factories for the
// azure.ai.skills extension. The factories produce *azdext.LocalError or
// *azdext.ServiceError values that the azd host renders consistently across
// extensions and uses to emit stable telemetry.
package exterrors
...
// Non-azcore errors are returned unchanged.
