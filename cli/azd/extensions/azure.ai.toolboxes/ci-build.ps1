...
$ldFlag = "-ldflags=-s -w -X azure.ai.toolboxes/internal/cmd.Version=$Version -X azure.ai.toolboxes/internal/cmd.Commit=$SourceVersion -X azure.ai.toolboxes/internal/cmd.BuildDate=$(Get-Date -Format o) "
