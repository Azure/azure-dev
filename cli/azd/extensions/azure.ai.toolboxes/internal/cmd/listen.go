...
import (
	"azure.ai.toolboxes/internal/project"

	"github.com/azure/azure-dev/cli/azd/pkg/azdext"
)

// configureExtensionHost registers the azure.ai.toolbox service target on the
...
func configureExtensionHost(host *azdext.ExtensionHost) {
	...
	host.WithServiceTarget(project.ToolboxHost, func() azdext.ServiceTargetProvider {
		return project.NewToolboxServiceTargetProvider(azdClient)
	})
}
