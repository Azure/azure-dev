...
type toolboxConnectionSpec = definition.ConnectionReference
type toolboxSkillSpec = definition.SkillReference
...
type toolboxCreateFile = definition.Definition
type toolboxPoliciesSpec = definition.Policies
type toolboxRaiConfigSpec = definition.RaiConfig
