...
$ldFlag = "-ldflags=-s -w -X azure.ai.training/internal/cmd.Version=$Version -X azure.ai.training/internal/cmd.Commit=$SourceVersion -X azure.ai.training/internal/cmd.BuildDate=$(Get-Date -Format o) "
