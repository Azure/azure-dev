...
func BuildAgentDefinitionFromManifest(
	agentManifest AgentManifest,
	options ...AgentBuildOption,
) (AgentDefinition, *AgentBuildConfig, error) {
	// Apply options
...
func CreateAgentAPIRequestFromManifest(
	agentManifest AgentManifest,
	options ...AgentBuildOption,
...
func CreateHostedAgentAPIRequest(
	agentDefinition AgentDefinition,
	buildConfig *AgentBuildConfig,
) (*agent_api.CreateAgentRequest, error) {
...
func CreateAgentAPIRequestFromAgentDefinition(
	agentDefinition AgentDefinition,
	buildConfig *AgentBuildConfig,
) (*agent_api.CreateAgentRequest, error) {
	// Route to appropriate handler based on agent kind
