...
func TestQuoteCmdArg(t *testing.T) {
	tests := []struct {
		...
		// Control character stripping (CWE-93)
		{name: "newline stripped", arg: "a\nb", want: "ab"},
		{name: "CR stripped", arg: "a\rb", want: "ab"},
		{name: "null stripped", arg: "a\x00b", want: "ab"},
		{name: "VT stripped", arg: "a\x0Bb", want: "ab"},
		{name: "FF stripped", arg: "a\x0Cb", want: "ab"},
		{name: "Ctrl-Z stripped", arg: "a\x1Ab", want: "ab"},
		{name: "ESC stripped", arg: "a\x1Bb", want: "ab"},
		{name: "newline with metachar", arg: "a\n&b", want: `"a&b"`},
		// Tab characters are also word separators in cmd.exe
		{name: "tab character", arg: "a\tb", want: "\"a\tb\""},
	}
