...
function serialize_azd_extensions_v1beta_GetDeploymentContextResponse(arg) {
  if (!(arg instanceof deployment_pb.GetDeploymentContextResponse)) {
    throw new Error('Expected argument of type azd.extensions.v1beta.GetDeploymentContextResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_azd_extensions_v1beta_GetDeploymentContextResponse(buffer_arg) {
  return deployment_pb.GetDeploymentContextResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_azd_extensions_v1beta_GetDeploymentResponse(arg) {
  if (!(arg instanceof deployment_pb.GetDeploymentResponse)) {
    throw new Error('Expected argument of type azd.extensions.v1beta.GetDeploymentResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_azd_extensions_v1beta_GetDeploymentResponse(buffer_arg) {
...
getDeployment: {
    path: '/azd.extensions.v1beta.DeploymentService/GetDeployment',
    requestStream: false,
    ...
    responseSerialize: serialize_azd_extensions_v1beta_GetDeploymentResponse,
    responseDeserialize: deserialize_azd_extensions_v1beta_GetDeploymentResponse,
  },
  // GetDeploymentContext retrieves the current deployment context.
getDeploymentContext: {
    path: '/azd.extensions.v1beta.DeploymentService/GetDeploymentContext',
    requestStream: false,
    responseStream: false,
    requestType: models_pb.EmptyRequest,
    ...
    requestSerialize: serialize_azd_extensions_v1beta_EmptyRequest,
    requestDeserialize: deserialize_azd_extensions_v1beta_EmptyRequest,
    responseSerialize: serialize_azd_extensions_v1beta_GetDeploymentContextResponse,
    responseDeserialize: deserialize_azd_extensions_v1beta_GetDeploymentContextResponse,
  },
};
