...
goog.exportSymbol('proto.azdext.HandlerOutput', null, global);
 ...
 * @constructor
 */
proto.azdext.HandlerOutput = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.azdext.HandlerOutput, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.azdext.HandlerOutput.displayName = 'proto.azdext.HandlerOutput';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.azdext.EventMessage.oneofGroups_ = [[1,2,3,4,5,6,7,8]];
...
handlerOutput: (f = msg.getHandlerOutput()) && proto.azdext.HandlerOutput.toObject(includeInstance, f)
  };
...
proto.azdext.EventMessage.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 7:
      ...
      break;
    case 8:
      var value = new proto.azdext.HandlerOutput;
      reader.readMessage(value,proto.azdext.HandlerOutput.deserializeBinaryFromReader);
...
proto.azdext.EventMessage.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      8,
      f,
      proto.azdext.HandlerOutput.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {?proto.azdext.HandlerOutput}
 */
proto.azdext.EventMessage.prototype.getHandlerOutput = function() {
  return /** @type{?proto.azdext.HandlerOutput} */ (
    jspb.Message.getWrapperField(this, proto.azdext.HandlerOutput, 8));
};


/**
 * @param {?proto.azdext.HandlerOutput|undefined} value
 * @return {!proto.azdext.EventMessage} returns this
*/
proto.azdext.EventMessage.prototype.setHandlerOutput = function(value) {
  return jspb.Message.setOneofWrapperField(this, 8, proto.azdext.EventMessage.oneofGroups_[0], value);
};
 ...
 * @return {!proto.azdext.EventMessage} returns this
 */
proto.azdext.EventMessage.prototype.clearHandlerOutput = function() {
 ...
 * @return {boolean}
 */
proto.azdext.EventMessage.prototype.hasHandlerOutput = function() {
 ...
 * @return {!Object}
 */
proto.azdext.HandlerOutput.prototype.toObject = function(opt_includeInstance) {
  return proto.azdext.HandlerOutput.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.azdext.HandlerOutput} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.azdext.HandlerOutput.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.azdext.HandlerOutput}
 */
proto.azdext.HandlerOutput.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.azdext.HandlerOutput;
  return proto.azdext.HandlerOutput.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.azdext.HandlerOutput} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.azdext.HandlerOutput}
 */
proto.azdext.HandlerOutput.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.azdext.HandlerOutput.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.azdext.HandlerOutput.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.azdext.HandlerOutput} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.azdext.HandlerOutput.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.azdext.HandlerOutput.prototype.getRequestId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.azdext.HandlerOutput} returns this
 */
proto.azdext.HandlerOutput.prototype.setRequestId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.azdext.HandlerOutput.prototype.getOutput = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.azdext.HandlerOutput} returns this
 */
proto.azdext.HandlerOutput.prototype.setOutput = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 */
proto.azdext.ProjectHandlerStatus.prototype.getError = function() {
  return /** @type{?proto.azdext.ExtensionError} */ (
    jspb.Message.getWrapperField(this, errors_pb.ExtensionError, 4));
};


/**
 * @param {?proto.azdext.ExtensionError|undefined} value
 * @return {!proto.azdext.ProjectHandlerStatus} returns this
*/
proto.azdext.ProjectHandlerStatus.prototype.setError = function(value) {
 ...
 * @return {!proto.azdext.ProjectHandlerStatus} returns this
 */
proto.azdext.ProjectHandlerStatus.prototype.clearError = function() {
 ...
 * @return {boolean}
 */
proto.azdext.ProjectHandlerStatus.prototype.hasError = function() {
  return jspb.Message.getField(this, 4) != null;
};
 ...
 * @return {?proto.azdext.ExtensionError}
 */
proto.azdext.ServiceHandlerStatus.prototype.getError = function() {
  return /** @type{?proto.azdext.ExtensionError} */ (
 ...
 * @return {!proto.azdext.ServiceHandlerStatus} returns this
*/
proto.azdext.ServiceHandlerStatus.prototype.setError = function(value) {
 ...
 * @return {!proto.azdext.ServiceHandlerStatus} returns this
 */
proto.azdext.ServiceHandlerStatus.prototype.clearError = function() {
  return this.setError(undefined);
};
 ...
 * @return {boolean}
 */
proto.azdext.ServiceHandlerStatus.prototype.hasError = function() {
  return jspb.Message.getField(this, 5) != null;
};
