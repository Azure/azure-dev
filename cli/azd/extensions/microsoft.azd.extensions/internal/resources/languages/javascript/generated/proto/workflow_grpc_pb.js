...
function serialize_azd_extensions_v1beta_RunWorkflowRequest(arg) {
  if (!(arg instanceof workflow_pb.RunWorkflowRequest)) {
    throw new Error('Expected argument of type azd.extensions.v1beta.RunWorkflowRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_azd_extensions_v1beta_RunWorkflowRequest(buffer_arg) {
...
run: {
    path: '/azd.extensions.v1beta.WorkflowService/Run',
    requestStream: false,
    responseStream: false,
    requestType: workflow_pb.RunWorkflowRequest,
    responseType: models_pb.EmptyResponse,
    requestSerialize: serialize_azd_extensions_v1beta_RunWorkflowRequest,
    requestDeserialize: deserialize_azd_extensions_v1beta_RunWorkflowRequest,
