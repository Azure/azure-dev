...
class DeploymentServiceServicer(object):
    ...
    def GetDeploymentContext(self, request, context):
...
def add_DeploymentServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetDeploymentContext': grpc.unary_unary_rpc_method_handler(
                    servicer.GetDeploymentContext,
                    request_deserializer=models__pb2.EmptyRequest.FromString,
                    response_serializer=deployment__pb2.GetDeploymentContextResponse.SerializeToString,
            ),
    }
...
class DeploymentService(object):
    ...
    @staticmethod
    def GetDeploymentContext(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
