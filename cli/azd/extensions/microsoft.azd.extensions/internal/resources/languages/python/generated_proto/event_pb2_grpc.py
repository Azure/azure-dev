...
class EventServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.EventStream = channel.stream_stream(
                '/azd.extensions.v1beta.EventService/EventStream',
...
def add_EventServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'azd.extensions.v1beta.EventService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('azd.extensions.v1beta.EventService', rpc_method_handlers)
