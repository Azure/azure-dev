...
class UserConfigServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Get = channel.unary_unary(
                '/azd.extensions.v1beta.UserConfigService/Get',
        ...
        self.GetString = channel.unary_unary(
                '/azd.extensions.v1beta.UserConfigService/GetString',
        ...
        self.GetSection = channel.unary_unary(
                '/azd.extensions.v1beta.UserConfigService/GetSection',
        ...
        self.Set = channel.unary_unary(
                '/azd.extensions.v1beta.UserConfigService/Set',
        ...
        self.Unset = channel.unary_unary(
                '/azd.extensions.v1beta.UserConfigService/Unset',
...
def add_UserConfigServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'azd.extensions.v1beta.UserConfigService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('azd.extensions.v1beta.UserConfigService', rpc_method_handlers)
