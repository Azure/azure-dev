...
func GenerateProjectArtifacts(
	...
	// panic if projectName contains spaces. This is because the project name is used to generate the name of containers
	// and other resources, and spaces are not allowed in those names.
	if strings.Contains(projectName, " ") {
		// Panic because this is a programming error, not a user error. ProjectName is typically generated by the system
		log.Panic("project name cannot contain spaces. The value provided was: " + projectName)
	}
