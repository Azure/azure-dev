...
func Test_ResourceService_CheckExistenceByID(t *testing.T) {
...
func Test_ResourceService_GetRawResource(t *testing.T) {
...
func Test_ResourceService_ListResourceGroupResources(t *testing.T) {
...
func Test_ResourceService_ListResourceGroup(t *testing.T) {
...
func Test_ResourceService_ListSubscriptionResources(t *testing.T) {
	t.Run("WithFilter", func(t *testing.T) {
		mockCtx := mocks.NewMockContext(t.Context())
		rs := NewResourceService(mockCtx.SubscriptionCredentialProvider, mockCtx.ArmClientOptions)
		mockCtx.HttpClient.When(func(req *http.Request) bool {
...
func Test_ResourceService_CreateOrUpdateResourceGroup(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		mockCtx := mocks.NewMockContext(t.Context())
		rs := NewResourceService(mockCtx.SubscriptionCredentialProvider, mockCtx.ArmClientOptions)
		mockCtx.HttpClient.When(func(req *http.Request) bool {
...
func Test_ResourceService_DeleteResourceGroup(t *testing.T) {
...
func Test_GroupByResourceGroup(t *testing.T) {
