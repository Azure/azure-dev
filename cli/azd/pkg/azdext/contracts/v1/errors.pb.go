...
// 	protoc        v6.32.1
// source: azd/extensions/v1/errors.proto
...
func (ErrorOrigin) Descriptor() protoreflect.EnumDescriptor {
	return file_azd_extensions_v1_errors_proto_enumTypes[0].Descriptor()
}

func (ErrorOrigin) Type() protoreflect.EnumType {
	return &file_azd_extensions_v1_errors_proto_enumTypes[0]
}
...
func (ErrorOrigin) EnumDescriptor() ([]byte, []int) {
	return file_azd_extensions_v1_errors_proto_rawDescGZIP(), []int{0}
}
...
func (x *ServiceErrorDetail) Reset() {
	*x = ServiceErrorDetail{}
	mi := &file_azd_extensions_v1_errors_proto_msgTypes[0]
...
func (x *LocalErrorDetail) Reset() {
	*x = LocalErrorDetail{}
	mi := &file_azd_extensions_v1_errors_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LocalErrorDetail) Descriptor() ([]byte, []int) {
	return file_azd_extensions_v1_errors_proto_rawDescGZIP(), []int{1}
}
...
type ExtensionError struct {
	...
	Origin     ErrorOrigin            `protobuf:"varint,4,opt,name=origin,proto3,enum=azd.extensions.v1.ErrorOrigin" json:"origin,omitempty"` // Where the error originated from
...
const file_azd_extensions_v1_errors_proto_rawDesc = "" +
	"\n" +
	"\x1eazd/extensions/v1/errors.proto\x12\x11azd.extensions.v1\"w\n" +
	...
	"suggestion\x122\n" +
	"\x05links\x18\x06 \x03(\v2\x1c.azd.extensions.v1.ErrorLinkR\x05links\x12L\n" +
	"\rservice_error\x18\n" +
	...
	"\x11ERROR_ORIGIN_TOOL\x10\x03B?Z=github.com/azure/azure-dev/cli/azd/pkg/azdext/contracts/v1;v1b\x06proto3"

var (
	file_azd_extensions_v1_errors_proto_rawDescOnce sync.Once
	file_azd_extensions_v1_errors_proto_rawDescData []byte
)

func file_azd_extensions_v1_errors_proto_rawDescGZIP() []byte {
	file_azd_extensions_v1_errors_proto_rawDescOnce.Do(func() {
		file_azd_extensions_v1_errors_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_azd_extensions_v1_errors_proto_rawDesc), len(file_azd_extensions_v1_errors_proto_rawDesc)))
	})
	return file_azd_extensions_v1_errors_proto_rawDescData
}
...
func file_azd_extensions_v1_errors_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_azd_extensions_v1_errors_proto_goTypes,
		DependencyIndexes: file_azd_extensions_v1_errors_proto_depIdxs,
		EnumInfos:         file_azd_extensions_v1_errors_proto_enumTypes,
		MessageInfos:      file_azd_extensions_v1_errors_proto_msgTypes,
	}.Build()
	File_azd_extensions_v1_errors_proto = out.File
	file_azd_extensions_v1_errors_proto_goTypes = nil
	file_azd_extensions_v1_errors_proto_depIdxs = nil
}
