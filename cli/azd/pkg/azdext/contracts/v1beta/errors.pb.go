...
// 	protoc        v6.32.1
// source: azd/extensions/v1beta/errors.proto
...
func (ErrorOrigin) Descriptor() protoreflect.EnumDescriptor {
	return file_azd_extensions_v1beta_errors_proto_enumTypes[0].Descriptor()
}

func (ErrorOrigin) Type() protoreflect.EnumType {
	return &file_azd_extensions_v1beta_errors_proto_enumTypes[0]
}
...
func (ErrorOrigin) EnumDescriptor() ([]byte, []int) {
	return file_azd_extensions_v1beta_errors_proto_rawDescGZIP(), []int{0}
}
...
func (x *ServiceErrorDetail) Reset() {
	*x = ServiceErrorDetail{}
	mi := &file_azd_extensions_v1beta_errors_proto_msgTypes[0]
...
func (x *LocalErrorDetail) Reset() {
	*x = LocalErrorDetail{}
	mi := &file_azd_extensions_v1beta_errors_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LocalErrorDetail) Descriptor() ([]byte, []int) {
	return file_azd_extensions_v1beta_errors_proto_rawDescGZIP(), []int{1}
}
...
func (x *ToolErrorDetail) Reset() {
	*x = ToolErrorDetail{}
	mi := &file_azd_extensions_v1beta_errors_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ToolErrorDetail) Descriptor() ([]byte, []int) {
	return file_azd_extensions_v1beta_errors_proto_rawDescGZIP(), []int{2}
}
...
func (x *ErrorLink) Reset() {
	*x = ErrorLink{}
	mi := &file_azd_extensions_v1beta_errors_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ErrorLink) Descriptor() ([]byte, []int) {
	return file_azd_extensions_v1beta_errors_proto_rawDescGZIP(), []int{3}
}
...
func (x *ActionableErrorDetail) Reset() {
	*x = ActionableErrorDetail{}
	mi := &file_azd_extensions_v1beta_errors_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ActionableErrorDetail) Descriptor() ([]byte, []int) {
	return file_azd_extensions_v1beta_errors_proto_rawDescGZIP(), []int{4}
}
...
type ExtensionError struct {
	...
	Origin     ErrorOrigin            `protobuf:"varint,4,opt,name=origin,proto3,enum=azd.extensions.v1beta.ErrorOrigin" json:"origin,omitempty"` // Where the error originated from
...
func (x *ExtensionError) Reset() {
	*x = ExtensionError{}
	mi := &file_azd_extensions_v1beta_errors_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExtensionError) Descriptor() ([]byte, []int) {
	return file_azd_extensions_v1beta_errors_proto_rawDescGZIP(), []int{5}
}
...
var File_azd_extensions_v1beta_errors_proto protoreflect.FileDescriptor

const file_azd_extensions_v1beta_errors_proto_rawDesc = "" +
	"\n" +
	"\"azd/extensions/v1beta/errors.proto\x12\x15azd.extensions.v1beta\"w\n" +
	...
	"suggestion\x126\n" +
	"\x05links\x18\x02 \x03(\v2 .azd.extensions.v1beta.ErrorLinkR\x05links\"\xbb\x03\n" +
	"\x0eExtensionError\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12:\n" +
	"\x06origin\x18\x04 \x01(\x0e2\".azd.extensions.v1beta.ErrorOriginR\x06origin\x12\x1e\n" +
	"\n" +
	"suggestion\x18\x05 \x01(\tR\n" +
	"suggestion\x126\n" +
	"\x05links\x18\x06 \x03(\v2 .azd.extensions.v1beta.ErrorLinkR\x05links\x12P\n" +
	"\rservice_error\x18\n" +
	" \x01(\v2).azd.extensions.v1beta.ServiceErrorDetailH\x00R\fserviceError\x12J\n" +
	"\vlocal_error\x18\v \x01(\v2'.azd.extensions.v1beta.LocalErrorDetailH\x00R\n" +
	"localError\x12G\n" +
	"\n" +
	"tool_error\x18\f \x01(\v2&.azd.extensions.v1beta.ToolErrorDetailH\x00R\ttoolErrorB\b\n" +
	...
	"\x11ERROR_ORIGIN_TOOL\x10\x03BGZEgithub.com/azure/azure-dev/cli/azd/pkg/azdext/contracts/v1beta;v1betab\x06proto3"

var (
	file_azd_extensions_v1beta_errors_proto_rawDescOnce sync.Once
	file_azd_extensions_v1beta_errors_proto_rawDescData []byte
)

func file_azd_extensions_v1beta_errors_proto_rawDescGZIP() []byte {
	file_azd_extensions_v1beta_errors_proto_rawDescOnce.Do(func() {
		file_azd_extensions_v1beta_errors_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_azd_extensions_v1beta_errors_proto_rawDesc), len(file_azd_extensions_v1beta_errors_proto_rawDesc)))
	})
	return file_azd_extensions_v1beta_errors_proto_rawDescData
}

var file_azd_extensions_v1beta_errors_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_azd_extensions_v1beta_errors_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_azd_extensions_v1beta_errors_proto_goTypes = []any{
	(ErrorOrigin)(0),              // 0: azd.extensions.v1beta.ErrorOrigin
	(*ServiceErrorDetail)(nil),    // 1: azd.extensions.v1beta.ServiceErrorDetail
	(*LocalErrorDetail)(nil),      // 2: azd.extensions.v1beta.LocalErrorDetail
	(*ToolErrorDetail)(nil),       // 3: azd.extensions.v1beta.ToolErrorDetail
	(*ErrorLink)(nil),             // 4: azd.extensions.v1beta.ErrorLink
	(*ActionableErrorDetail)(nil), // 5: azd.extensions.v1beta.ActionableErrorDetail
	(*ExtensionError)(nil),        // 6: azd.extensions.v1beta.ExtensionError
}
var file_azd_extensions_v1beta_errors_proto_depIdxs = []int32{
	4, // 0: azd.extensions.v1beta.ActionableErrorDetail.links:type_name -> azd.extensions.v1beta.ErrorLink
	0, // 1: azd.extensions.v1beta.ExtensionError.origin:type_name -> azd.extensions.v1beta.ErrorOrigin
	4, // 2: azd.extensions.v1beta.ExtensionError.links:type_name -> azd.extensions.v1beta.ErrorLink
	1, // 3: azd.extensions.v1beta.ExtensionError.service_error:type_name -> azd.extensions.v1beta.ServiceErrorDetail
	2, // 4: azd.extensions.v1beta.ExtensionError.local_error:type_name -> azd.extensions.v1beta.LocalErrorDetail
	3, // 5: azd.extensions.v1beta.ExtensionError.tool_error:type_name -> azd.extensions.v1beta.ToolErrorDetail
...
func init() { file_azd_extensions_v1beta_errors_proto_init() }
func file_azd_extensions_v1beta_errors_proto_init() {
	if File_azd_extensions_v1beta_errors_proto != nil {
		return
	}
	file_azd_extensions_v1beta_errors_proto_msgTypes[2].OneofWrappers = []any{}
	file_azd_extensions_v1beta_errors_proto_msgTypes[5].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_azd_extensions_v1beta_errors_proto_rawDesc), len(file_azd_extensions_v1beta_errors_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_azd_extensions_v1beta_errors_proto_goTypes,
		DependencyIndexes: file_azd_extensions_v1beta_errors_proto_depIdxs,
		EnumInfos:         file_azd_extensions_v1beta_errors_proto_enumTypes,
		MessageInfos:      file_azd_extensions_v1beta_errors_proto_msgTypes,
	}.Build()
	File_azd_extensions_v1beta_errors_proto = out.File
	file_azd_extensions_v1beta_errors_proto_goTypes = nil
	file_azd_extensions_v1beta_errors_proto_depIdxs = nil
}
