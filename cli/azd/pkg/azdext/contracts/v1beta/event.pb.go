...
// 	protoc        v6.32.1
// source: azd/extensions/v1beta/event.proto
...
func (x *EventMessage) Reset() {
	*x = EventMessage{}
	mi := &file_azd_extensions_v1beta_event_proto_msgTypes[0]
...
const file_azd_extensions_v1beta_event_proto_rawDesc = "" +
	...
	"\aservice\x18\x03 \x01(\v2$.azd.extensions.v1beta.ServiceConfigR\aservice\x12N\n" +
	"\x0fservice_context\x18\x04 \x01(\v2%.azd.extensions.v1beta.ServiceContextR\x0eserviceContext\"\xd4\x01\n" +
	"\x14ProjectHandlerStatus\x12\x1d\n" +
	"\n" +
	"event_name\x18\x01 \x01(\tR\teventName\x12\x16\n" +
	"\x06status\x18\x02 \x01(\tR\x06status\x12\x18\n" +
	"\amessage\x18\x03 \x01(\tR\amessage\x12;\n" +
	"\x05error\x18\x04 \x01(\v2%.azd.extensions.v1beta.ExtensionErrorR\x05error\x12 \n" +
...
var (
	file_azd_extensions_v1beta_event_proto_rawDescOnce sync.Once
	file_azd_extensions_v1beta_event_proto_rawDescData []byte
)

func file_azd_extensions_v1beta_event_proto_rawDescGZIP() []byte {
	file_azd_extensions_v1beta_event_proto_rawDescOnce.Do(func() {
		file_azd_extensions_v1beta_event_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_azd_extensions_v1beta_event_proto_rawDesc), len(file_azd_extensions_v1beta_event_proto_rawDesc)))
	})
...
func file_azd_extensions_v1beta_event_proto_init() {
	if File_azd_extensions_v1beta_event_proto != nil {
		return
	}
	file_azd_extensions_v1beta_models_proto_init()
	file_azd_extensions_v1beta_errors_proto_init()
	file_azd_extensions_v1beta_event_proto_msgTypes[0].OneofWrappers = []any{
	...
	file_azd_extensions_v1beta_event_proto_msgTypes[5].OneofWrappers = []any{}
	type x struct{}
	...
	file_azd_extensions_v1beta_event_proto_goTypes = nil
	file_azd_extensions_v1beta_event_proto_depIdxs = nil
}
