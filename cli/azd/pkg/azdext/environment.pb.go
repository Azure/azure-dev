...
type UnsetEnvRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	EnvName       string                 `protobuf:"bytes,1,opt,name=env_name,json=envName,proto3" json:"env_name,omitempty"` // Optional: Name of the environment. If empty, uses default.
	Key           string                 `protobuf:"bytes,2,opt,name=key,proto3" json:"key,omitempty"`                        // Key to remove.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UnsetEnvRequest) GetEnvName() string {
	if x != nil {
		return x.EnvName
	}
	return ""
...
func (x *UnsetEnvRequest) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
var file_environment_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
var file_environment_proto_goTypes = []any{
	...
	(*UnsetEnvRequest)(nil),          // 4: azdext.UnsetEnvRequest
	(*EnvironmentResponse)(nil),      // 5: azdext.EnvironmentResponse
	(*EnvironmentListResponse)(nil),  // 6: azdext.EnvironmentListResponse
	(*KeyValueListResponse)(nil),     // 7: azdext.KeyValueListResponse
	(*KeyValueResponse)(nil),         // 8: azdext.KeyValueResponse
	(*Environment)(nil),              // 9: azdext.Environment
	(*EnvironmentDescription)(nil),   // 10: azdext.EnvironmentDescription
	(*KeyValue)(nil),                 // 11: azdext.KeyValue
	(*GetConfigRequest)(nil),         // 12: azdext.GetConfigRequest
	(*GetConfigResponse)(nil),        // 13: azdext.GetConfigResponse
	(*GetConfigStringRequest)(nil),   // 14: azdext.GetConfigStringRequest
	(*GetConfigStringResponse)(nil),  // 15: azdext.GetConfigStringResponse
	(*GetConfigSectionRequest)(nil),  // 16: azdext.GetConfigSectionRequest
	(*GetConfigSectionResponse)(nil), // 17: azdext.GetConfigSectionResponse
	(*SetConfigRequest)(nil),         // 18: azdext.SetConfigRequest
	(*UnsetConfigRequest)(nil),       // 19: azdext.UnsetConfigRequest
	(*EmptyRequest)(nil),             // 20: azdext.EmptyRequest
	(*EmptyResponse)(nil),            // 21: azdext.EmptyResponse
}
var file_environment_proto_depIdxs = []int32{
	9,  // 0: azdext.EnvironmentResponse.environment:type_name -> azdext.Environment
	10, // 1: azdext.EnvironmentListResponse.environments:type_name -> azdext.EnvironmentDescription
	11, // 2: azdext.KeyValueListResponse.key_values:type_name -> azdext.KeyValue
	20, // 3: azdext.EnvironmentService.GetCurrent:input_type -> azdext.EmptyRequest
	...
	4,  // 10: azdext.EnvironmentService.UnsetValue:input_type -> azdext.UnsetEnvRequest
	12, // 11: azdext.EnvironmentService.GetConfig:input_type -> azdext.GetConfigRequest
	14, // 12: azdext.EnvironmentService.GetConfigString:input_type -> azdext.GetConfigStringRequest
	16, // 13: azdext.EnvironmentService.GetConfigSection:input_type -> azdext.GetConfigSectionRequest
	18, // 14: azdext.EnvironmentService.SetConfig:input_type -> azdext.SetConfigRequest
	19, // 15: azdext.EnvironmentService.UnsetConfig:input_type -> azdext.UnsetConfigRequest
	5,  // 16: azdext.EnvironmentService.GetCurrent:output_type -> azdext.EnvironmentResponse
	6,  // 17: azdext.EnvironmentService.List:output_type -> azdext.EnvironmentListResponse
	5,  // 18: azdext.EnvironmentService.Get:output_type -> azdext.EnvironmentResponse
	21, // 19: azdext.EnvironmentService.Select:output_type -> azdext.EmptyResponse
	7,  // 20: azdext.EnvironmentService.GetValues:output_type -> azdext.KeyValueListResponse
	8,  // 21: azdext.EnvironmentService.GetValue:output_type -> azdext.KeyValueResponse
	21, // 22: azdext.EnvironmentService.SetValue:output_type -> azdext.EmptyResponse
	21, // 23: azdext.EnvironmentService.UnsetValue:output_type -> azdext.EmptyResponse
	13, // 24: azdext.EnvironmentService.GetConfig:output_type -> azdext.GetConfigResponse
	15, // 25: azdext.EnvironmentService.GetConfigString:output_type -> azdext.GetConfigStringResponse
	17, // 26: azdext.EnvironmentService.GetConfigSection:output_type -> azdext.GetConfigSectionResponse
	21, // 27: azdext.EnvironmentService.SetConfig:output_type -> azdext.EmptyResponse
	21, // 28: azdext.EnvironmentService.UnsetConfig:output_type -> azdext.EmptyResponse
