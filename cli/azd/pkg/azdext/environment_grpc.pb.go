...
type EnvironmentServiceClient interface {
	...
	UnsetValue(ctx context.Context, in *GetEnvRequest, opts ...grpc.CallOption) (*EmptyResponse, error)
...
func (c *environmentServiceClient) UnsetValue(ctx context.Context, in *GetEnvRequest, opts ...grpc.CallOption) (*EmptyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EmptyResponse)
...
type EnvironmentServiceServer interface {
	...
	// UnsetValue removes a key from the specified environment.
	UnsetValue(context.Context, *GetEnvRequest) (*EmptyResponse, error)
	// GetConfig retrieves a config value by path
...
func (UnimplementedEnvironmentServiceServer) UnsetValue(context.Context, *GetEnvRequest) (*EmptyResponse, error) {
...
func _EnvironmentService_UnsetValue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EnvironmentServiceServer).UnsetValue(ctx, req.(*GetEnvRequest))
	}
	return interceptor(ctx, in, info, handler)
}
