...
const (
	...
	EnvironmentService_UnsetValue_FullMethodName       = "/azdext.EnvironmentService/UnsetValue"
...
type EnvironmentServiceClient interface {
	...
	UnsetValue(ctx context.Context, in *UnsetEnvRequest, opts ...grpc.CallOption) (*EmptyResponse, error)
...
func (c *environmentServiceClient) UnsetValue(ctx context.Context, in *UnsetEnvRequest, opts ...grpc.CallOption) (*EmptyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EmptyResponse)
	err := c.cc.Invoke(ctx, EnvironmentService_UnsetValue_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EnvironmentServiceServer interface {
	...
	// UnsetValue removes a key from the specified environment.
	UnsetValue(context.Context, *UnsetEnvRequest) (*EmptyResponse, error)
	// GetConfig retrieves a config value by path
...
func (UnimplementedEnvironmentServiceServer) UnsetValue(context.Context, *UnsetEnvRequest) (*EmptyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UnsetValue not implemented")
}
...
func _EnvironmentService_UnsetValue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UnsetEnvRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EnvironmentServiceServer).UnsetValue(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EnvironmentService_UnsetValue_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EnvironmentServiceServer).UnsetValue(ctx, req.(*UnsetEnvRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var EnvironmentService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UnsetValue",
			Handler:    _EnvironmentService_UnsetValue_Handler,
		},
		{
