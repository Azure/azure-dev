...
// WorkflowErrorDetail carries an extension error from a delegated workflow.
...
func (x *WorkflowErrorDetail) GetError() *ExtensionError {
	if x != nil {
		return x.Error
	}
	return nil
...
var file_errors_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_errors_proto_goTypes = []any{
	...
	(*WorkflowErrorDetail)(nil),   // 5: azdext.WorkflowErrorDetail
	(*ExtensionError)(nil),        // 6: azdext.ExtensionError
}
var file_errors_proto_depIdxs = []int32{
	3, // 0: azdext.ActionableErrorDetail.links:type_name -> azdext.ErrorLink
	6, // 1: azdext.WorkflowErrorDetail.error:type_name -> azdext.ExtensionError
	0, // 2: azdext.ExtensionError.origin:type_name -> azdext.ErrorOrigin
	3, // 3: azdext.ExtensionError.links:type_name -> azdext.ErrorLink
	1, // 4: azdext.ExtensionError.service_error:type_name -> azdext.ServiceErrorDetail
	2, // 5: azdext.ExtensionError.local_error:type_name -> azdext.LocalErrorDetail
...
func file_errors_proto_init() {
	...
	file_errors_proto_msgTypes[5].OneofWrappers = []any{
