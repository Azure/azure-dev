...
type InfraOptions struct {
	...
	Outputs          map[string]string      `protobuf:"bytes,8,rep,name=outputs,proto3" json:"outputs,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
func (x *InfraOptions) GetInputs() map[string]string {
	if x != nil {
		return x.Inputs
	}
	return nil
...
func (x *InfraOptions) GetOutputs() map[string]string {
	if x != nil {
		return x.Outputs
	}
	return nil
...
const file_models_proto_rawDesc = "" +
	...
	"\n" +
	"depends_on\x18\x06 \x03(\tR\tdependsOn\x128\n" +
	"\x06inputs\x18\a \x03(\v2 .azdext.InfraOptions.InputsEntryR\x06inputs\x12;\n" +
	"\aoutputs\x18\b \x03(\v2!.azdext.InfraOptions.OutputsEntryR\aoutputs\x12-\n" +
	"\x05hooks\x18\t \x01(\v2\x17.google.protobuf.StructR\x05hooks\x12D\n" +
	"\x11deployment_stacks\x18\n" +
	" \x01(\v2\x17.google.protobuf.StructR\x10deploymentStacks\x1a9\n" +
...
var file_models_proto_goTypes = []any{
	...
	nil,                          // 22: azdext.InfraOptions.InputsEntry
	nil,                          // 23: azdext.InfraOptions.OutputsEntry
	nil,                          // 24: azdext.Artifact.MetadataEntry
...
var file_models_proto_depIdxs = []int32{
	...
	25, // 4: azdext.ProjectConfig.additional_properties:type_name -> google.protobuf.Struct
	16, // 5: azdext.ServiceConfig.docker:type_name -> azdext.DockerProjectOptions
	25, // 6: azdext.ServiceConfig.config:type_name -> google.protobuf.Struct
	25, // 7: azdext.ServiceConfig.additional_properties:type_name -> google.protobuf.Struct
	21, // 8: azdext.ServiceConfig.environment:type_name -> azdext.ServiceConfig.EnvironmentEntry
	25, // 9: azdext.ServiceConfig.k8s:type_name -> google.protobuf.Struct
	15, // 10: azdext.ServiceConfig.infra:type_name -> azdext.InfraOptions
	25, // 11: azdext.ServiceConfig.hooks:type_name -> google.protobuf.Struct
	25, // 12: azdext.InfraOptions.config:type_name -> google.protobuf.Struct
	22, // 13: azdext.InfraOptions.inputs:type_name -> azdext.InfraOptions.InputsEntry
	23, // 14: azdext.InfraOptions.outputs:type_name -> azdext.InfraOptions.OutputsEntry
	25, // 15: azdext.InfraOptions.hooks:type_name -> google.protobuf.Struct
	25, // 16: azdext.InfraOptions.deployment_stacks:type_name -> google.protobuf.Struct
	19, // 17: azdext.ServiceContext.restore:type_name -> azdext.Artifact
	19, // 18: azdext.ServiceContext.build:type_name -> azdext.Artifact
	19, // 19: azdext.ServiceContext.package:type_name -> azdext.Artifact
	19, // 20: azdext.ServiceContext.publish:type_name -> azdext.Artifact
	19, // 21: azdext.ServiceContext.deploy:type_name -> azdext.Artifact
	19, // 22: azdext.ArtifactList.artifacts:type_name -> azdext.Artifact
	0,  // 23: azdext.Artifact.kind:type_name -> azdext.ArtifactKind
	1,  // 24: azdext.Artifact.location_kind:type_name -> azdext.LocationKind
	24, // 25: azdext.Artifact.metadata:type_name -> azdext.Artifact.MetadataEntry
	14, // 26: azdext.ProjectConfig.ServicesEntry.value:type_name -> azdext.ServiceConfig
