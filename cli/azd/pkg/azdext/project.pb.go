...
// Request message for PatchServiceConfig.
type PatchServiceConfigRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Literal service map key. Dots are not treated as path separators.
	ServiceName string `protobuf:"bytes,1,opt,name=service_name,json=serviceName,proto3" json:"service_name,omitempty"`
	// Required ownership discriminator. Existing services must have this host;
	// newly created services receive it. The patch cannot modify host.
	RequiredHost string `protobuf:"bytes,2,opt,name=required_host,json=requiredHost,proto3" json:"required_host,omitempty"`
	// Creates the service when it does not exist.
	...
	// Service-relative dot paths to set. Null values on extension-owned fields
	// are stored as YAML null; typed service fields reject null.
	SetValues map[string]*structpb.Value `protobuf:"bytes,4,rep,name=set_values,json=setValues,proto3" json:"set_values,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// Service-relative dot paths to remove. Removals run before sets.
	UnsetPaths []string `protobuf:"bytes,5,rep,name=unset_paths,json=unsetPaths,proto3" json:"unset_paths,omitempty"`
	// Optional optimistic concurrency guard. When present, the patch is aborted
	// unless the service's current uses list matches exactly. A missing uses
	// field is equivalent to an empty list.
	ExpectedUses  *StringListValue `protobuf:"bytes,6,opt,name=expected_uses,json=expectedUses,proto3" json:"expected_uses,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *PatchServiceConfigRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *PatchServiceConfigRequest) GetServiceName() string {
	if x != nil {
		return x.ServiceName
	}
	return ""
...
func (x *PatchServiceConfigRequest) GetRequiredHost() string {
	if x != nil {
		return x.RequiredHost
	}
	return ""
}

func (x *PatchServiceConfigRequest) GetCreateIfMissing() bool {
	if x != nil {
...
func (x *PatchServiceConfigRequest) GetSetValues() map[string]*structpb.Value {
	if x != nil {
		return x.SetValues
	}
	return nil
...
func (x *PatchServiceConfigRequest) GetUnsetPaths() []string {
	if x != nil {
		return x.UnsetPaths
	}
	return nil
...
func (x *PatchServiceConfigRequest) GetExpectedUses() *StringListValue {
	if x != nil {
		return x.ExpectedUses
	}
	return nil
}
...
const file_project_proto_rawDesc = "" +
	...
	"\fservice_name\x18\x01 \x01(\tR\vserviceName\x12\x12\n" +
	"\x04path\x18\x02 \x01(\tR\x04path\"\x95\x03\n" +
	"\x19PatchServiceConfigRequest\x12!\n" +
	"\fservice_name\x18\x01 \x01(\tR\vserviceName\x12#\n" +
	"\rrequired_host\x18\x02 \x01(\tR\frequiredHost\x12*\n" +
	"\x11create_if_missing\x18\x03 \x01(\bR\x0fcreateIfMissing\x12O\n" +
	"\n" +
	"set_values\x18\x04 \x03(\v20.azdext.PatchServiceConfigRequest.SetValuesEntryR\tsetValues\x12\x1f\n" +
	"\vunset_paths\x18\x05 \x03(\tR\n" +
	"unsetPaths\x12<\n" +
	"\rexpected_uses\x18\x06 \x01(\v2\x17.azdext.StringListValueR\fexpectedUses\x1aT\n" +
	"\x0eSetValuesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12,\n" +
	...
	"\x0ftarget_resource\x18\x01 \x01(\v2\x16.azdext.TargetResourceR\x0etargetResource2\xec\n" +
	"\n" +
	...
	"\x12UnsetServiceConfig\x12!.azdext.UnsetServiceConfigRequest\x1a\x15.azdext.EmptyResponse\x12N\n" +
	"\x12PatchServiceConfig\x12!.azdext.PatchServiceConfigRequest\x1a\x15.azdext.EmptyResponseB/Z-github.com/azure/azure-dev/cli/azd/pkg/azdextb\x06proto3"
...
var file_project_proto_goTypes = []any{
	...
	(*PatchServiceConfigRequest)(nil),        // 19: azdext.PatchServiceConfigRequest
	(*StringListValue)(nil),                  // 20: azdext.StringListValue
	(*GetServiceTargetResourceRequest)(nil),  // 21: azdext.GetServiceTargetResourceRequest
	(*GetServiceTargetResourceResponse)(nil), // 22: azdext.GetServiceTargetResourceResponse
	nil,                                      // 23: azdext.GetResolvedServicesResponse.ServicesEntry
	nil,                                      // 24: azdext.PatchServiceConfigRequest.SetValuesEntry
	(*ProjectConfig)(nil),                    // 25: azdext.ProjectConfig
	(*ServiceConfig)(nil),                    // 26: azdext.ServiceConfig
	(*structpb.Struct)(nil),                  // 27: google.protobuf.Struct
	(*structpb.Value)(nil),                   // 28: google.protobuf.Value
	(*TargetResource)(nil),                   // 29: azdext.TargetResource
	(*EmptyRequest)(nil),                     // 30: azdext.EmptyRequest
	(*EmptyResponse)(nil),                    // 31: azdext.EmptyResponse
}
var file_project_proto_depIdxs = []int32{
	25, // 0: azdext.GetProjectResponse.project:type_name -> azdext.ProjectConfig
	26, // 1: azdext.AddServiceRequest.service:type_name -> azdext.ServiceConfig
	23, // 2: azdext.GetResolvedServicesResponse.services:type_name -> azdext.GetResolvedServicesResponse.ServicesEntry
	27, // 3: azdext.GetProjectConfigSectionResponse.section:type_name -> google.protobuf.Struct
	28, // 4: azdext.GetProjectConfigValueResponse.value:type_name -> google.protobuf.Value
	27, // 5: azdext.SetProjectConfigSectionRequest.section:type_name -> google.protobuf.Struct
	28, // 6: azdext.SetProjectConfigValueRequest.value:type_name -> google.protobuf.Value
	27, // 7: azdext.GetServiceConfigSectionResponse.section:type_name -> google.protobuf.Struct
	28, // 8: azdext.GetServiceConfigValueResponse.value:type_name -> google.protobuf.Value
	27, // 9: azdext.SetServiceConfigSectionRequest.section:type_name -> google.protobuf.Struct
	28, // 10: azdext.SetServiceConfigValueRequest.value:type_name -> google.protobuf.Value
	24, // 11: azdext.PatchServiceConfigRequest.set_values:type_name -> azdext.PatchServiceConfigRequest.SetValuesEntry
	20, // 12: azdext.PatchServiceConfigRequest.expected_uses:type_name -> azdext.StringListValue
	29, // 13: azdext.GetServiceTargetResourceResponse.target_resource:type_name -> azdext.TargetResource
	26, // 14: azdext.GetResolvedServicesResponse.ServicesEntry.value:type_name -> azdext.ServiceConfig
	28, // 15: azdext.PatchServiceConfigRequest.SetValuesEntry.value:type_name -> google.protobuf.Value
	30, // 16: azdext.ProjectService.Get:input_type -> azdext.EmptyRequest
	21, // 17: azdext.ProjectService.GetServiceTargetResource:input_type -> azdext.GetServiceTargetResourceRequest
	1,  // 18: azdext.ProjectService.AddService:input_type -> azdext.AddServiceRequest
	30, // 19: azdext.ProjectService.GetResolvedServices:input_type -> azdext.EmptyRequest
	3,  // 20: azdext.ProjectService.ParseGitHubUrl:input_type -> azdext.ParseGitHubUrlRequest
	4,  // 21: azdext.ProjectService.GetConfigSection:input_type -> azdext.GetProjectConfigSectionRequest
	7,  // 22: azdext.ProjectService.GetConfigValue:input_type -> azdext.GetProjectConfigValueRequest
	9,  // 23: azdext.ProjectService.SetConfigSection:input_type -> azdext.SetProjectConfigSectionRequest
	10, // 24: azdext.ProjectService.SetConfigValue:input_type -> azdext.SetProjectConfigValueRequest
	11, // 25: azdext.ProjectService.UnsetConfig:input_type -> azdext.UnsetProjectConfigRequest
	12, // 26: azdext.ProjectService.GetServiceConfigSection:input_type -> azdext.GetServiceConfigSectionRequest
	14, // 27: azdext.ProjectService.GetServiceConfigValue:input_type -> azdext.GetServiceConfigValueRequest
	16, // 28: azdext.ProjectService.SetServiceConfigSection:input_type -> azdext.SetServiceConfigSectionRequest
	17, // 29: azdext.ProjectService.SetServiceConfigValue:input_type -> azdext.SetServiceConfigValueRequest
	18, // 30: azdext.ProjectService.UnsetServiceConfig:input_type -> azdext.UnsetServiceConfigRequest
	19, // 31: azdext.ProjectService.PatchServiceConfig:input_type -> azdext.PatchServiceConfigRequest
	0,  // 32: azdext.ProjectService.Get:output_type -> azdext.GetProjectResponse
	22, // 33: azdext.ProjectService.GetServiceTargetResource:output_type -> azdext.GetServiceTargetResourceResponse
	31, // 34: azdext.ProjectService.AddService:output_type -> azdext.EmptyResponse
	2,  // 35: azdext.ProjectService.GetResolvedServices:output_type -> azdext.GetResolvedServicesResponse
	6,  // 36: azdext.ProjectService.ParseGitHubUrl:output_type -> azdext.ParseGitHubUrlResponse
	5,  // 37: azdext.ProjectService.GetConfigSection:output_type -> azdext.GetProjectConfigSectionResponse
	8,  // 38: azdext.ProjectService.GetConfigValue:output_type -> azdext.GetProjectConfigValueResponse
	31, // 39: azdext.ProjectService.SetConfigSection:output_type -> azdext.EmptyResponse
	31, // 40: azdext.ProjectService.SetConfigValue:output_type -> azdext.EmptyResponse
	31, // 41: azdext.ProjectService.UnsetConfig:output_type -> azdext.EmptyResponse
	13, // 42: azdext.ProjectService.GetServiceConfigSection:output_type -> azdext.GetServiceConfigSectionResponse
	15, // 43: azdext.ProjectService.GetServiceConfigValue:output_type -> azdext.GetServiceConfigValueResponse
	31, // 44: azdext.ProjectService.SetServiceConfigSection:output_type -> azdext.EmptyResponse
	31, // 45: azdext.ProjectService.SetServiceConfigValue:output_type -> azdext.EmptyResponse
	31, // 46: azdext.ProjectService.UnsetServiceConfig:output_type -> azdext.EmptyResponse
	31, // 47: azdext.ProjectService.PatchServiceConfig:output_type -> azdext.EmptyResponse
