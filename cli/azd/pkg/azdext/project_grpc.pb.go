...
const (
	...
	ProjectService_PatchServiceConfig_FullMethodName       = "/azdext.ProjectService/PatchServiceConfig"
)
...
type ProjectServiceClient interface {
	...
	PatchServiceConfig(ctx context.Context, in *PatchServiceConfigRequest, opts ...grpc.CallOption) (*EmptyResponse, error)
}
...
func (c *projectServiceClient) PatchServiceConfig(ctx context.Context, in *PatchServiceConfigRequest, opts ...grpc.CallOption) (*EmptyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EmptyResponse)
	err := c.cc.Invoke(ctx, ProjectService_PatchServiceConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProjectServiceServer interface {
	...
	// Creates or patches a service under one process-local mutation lock.
	PatchServiceConfig(context.Context, *PatchServiceConfigRequest) (*EmptyResponse, error)
...
func (UnimplementedProjectServiceServer) PatchServiceConfig(context.Context, *PatchServiceConfigRequest) (*EmptyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PatchServiceConfig not implemented")
}
...
func _ProjectService_PatchServiceConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PatchServiceConfigRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProjectServiceServer).PatchServiceConfig(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProjectService_PatchServiceConfig_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProjectServiceServer).PatchServiceConfig(ctx, req.(*PatchServiceConfigRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProjectService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ProjectService_PatchServiceConfig_Handler,
		},
	},
