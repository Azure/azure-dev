...
// Preview must work on a fresh provider without initialization or deployment preparation.
	...
	return &v1beta.ServiceTargetMessage{
		MessageType: &v1beta.ServiceTargetMessage_PreviewResponse{
			PreviewResponse: &v1beta.ServiceTargetPreviewResponse{
				Result: &v1beta.ServiceDeployPreviewResult{Message: result.Message, Data: result.Data},
			},
		},
	}, nil
}
