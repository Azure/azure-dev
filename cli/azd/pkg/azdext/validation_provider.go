...
type ValidationContext struct {
	...
	ContextID string
	// CheckType identifies the validation context (e.g. "provision").
	CheckType string
...
// validation pipeline (e.g. provision checks during provisioning).
...
// --- Context key constants for "provision" checks ---

const (
	// ValidationContextResourcesSnapshot is the key for the raw Bicep
	// snapshot JSON in a "provision" check context.
