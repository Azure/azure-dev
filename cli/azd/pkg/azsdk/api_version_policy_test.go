...
func TestOverrideApiVersion(t *testing.T) {
	...
	clientOptions := NewClientOptionsBuilder().
		...
		WithPolicy(NewApiVersionPolicy(expectedApiVersion)).
	...
	require.Equal(t, expectedApiVersion, response.Request.URL.Query().Get("api-version"))
}
