...
type ActionFunc func(context.Context, *cobra.Command, []string, *azd_context.AzdContext) error

// Run implements the Action interface
func (a ActionFunc) Run(ctx context.Context, cmd *cobra.Command, args []string, azdCtx *azd_context.AzdContext) error {
...
type Action interface {
	Run(ctx context.Context, cmd *cobra.Command, args []string, azdCtx *azd_context.AzdContext) error
	SetupFlags(
...
func (a *compositeAction) Run(ctx context.Context, cmd *cobra.Command, args []string, azdCtx *azd_context.AzdContext) error {
