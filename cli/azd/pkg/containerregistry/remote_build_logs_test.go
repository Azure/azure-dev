	...
	tests := []struct {
	...
	}{
		{
			...
			responses: []logBlobResponse{
				...
				{method: http.MethodGet, body: "one\n", byteRange: "bytes=0-3", ifMatch: `"1"`},
				{method: http.MethodHead, body: "one\ntwo\n", etag: `"2"`},
				{method: http.MethodGet, body: "one\n", byteRange: "bytes=0-3", ifMatch: `"2"`},
				{method: http.MethodGet, body: "two\n", byteRange: "bytes=4-7", ifMatch: `"2"`},
				{method: http.MethodHead, body: "one\ntwo\n", etag: `"2"`, complete: true},
			},
			output: "one\ntwo\n",
		},
		{
		...
		{
			name: "equal length replacement is read from zero",
			responses: []logBlobResponse{
		...
		{
			name: "larger replacement is read from zero",
			responses: []logBlobResponse{
				{method: http.MethodHead, body: "old\n", etag: `"1"`},
				{method: http.MethodGet, body: "old\n", byteRange: "bytes=0-3", ifMatch: `"1"`},
				{method: http.MethodHead, body: "new attempt\n", etag: `"2"`},
				{method: http.MethodGet, body: "new ", byteRange: "bytes=0-3", ifMatch: `"2"`},
				{method: http.MethodGet, body: "new attempt\n", byteRange: "bytes=0-11", ifMatch: `"2"`},
				{method: http.MethodHead, body: "new attempt\n", etag: `"2"`, complete: true},
			},
			output: "old\nnew attempt\n",
		},
		...
		{
			name: "stale etag replacement resets even if the new log grows before the next HEAD",
			responses: []logBlobResponse{
				{method: http.MethodHead, body: "old\n", etag: `"1"`},
				{method: http.MethodGet, body: "old\n", byteRange: "bytes=0-3", ifMatch: `"1"`},
				{method: http.MethodHead, body: "old\nmore\n", etag: `"2"`},
				{method: http.MethodGet, byteRange: "bytes=0-3", ifMatch: `"2"`, status: http.StatusPreconditionFailed},
				{method: http.MethodHead, body: "new attempt\n", etag: `"3"`},
				{method: http.MethodGet, body: "new ", byteRange: "bytes=0-3", ifMatch: `"3"`},
				{method: http.MethodGet, body: "new attempt\n", byteRange: "bytes=0-11", ifMatch: `"3"`},
				{method: http.MethodHead, body: "new attempt\n", etag: `"3"`, complete: true},
			},
			output: "old\nnew attempt\n",
		},
		{
			...
			responses: []logBlobResponse{
				...
				{method: http.MethodHead, body: "a\nb\n", etag: `"2"`},
				{method: http.MethodGet, byteRange: "bytes=0-1", ifMatch: `"2"`, status: http.StatusPreconditionFailed},
				{method: http.MethodHead, body: "a\nb\nc\n", etag: `"3"`},
				{method: http.MethodGet, body: "a\n", byteRange: "bytes=0-1", ifMatch: `"3"`},
