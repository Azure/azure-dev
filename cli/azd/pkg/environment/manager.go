...
func (m *manager) LoadOrInitInteractive(ctx context.Context, environmentName string) (*Environment, error) {
	...
	if isNew {
		...
		if err := azdcontext.SetDefaultEnvironmentName(m.azdContext, env.Name()); err != nil {
...
func (m *manager) loadOrInitEnvironment(ctx context.Context, environmentName string) (*Environment, bool, error) {
	...
	if environmentName == "" {
		var err error
		environmentName, err = azdcontext.DefaultEnvironmentName(m.azdContext)
		if err != nil {
...
func (m *manager) List(ctx context.Context) ([]*Description, error) {
	...
	defaultEnvName, err := azdcontext.DefaultEnvironmentName(m.azdContext)
	if err != nil {
		defaultEnvName = ""
	}
...
func (m *manager) Delete(ctx context.Context, name string) error {
	...
	if defaultEnvName == name {
		err = azdcontext.SetDefaultEnvironmentName(m.azdContext, "")
		if err != nil {
