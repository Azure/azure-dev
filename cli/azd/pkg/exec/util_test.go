...
"accessToken": "<redacted>"
		...
		{scenario: "SWADeploymentToken",
			// nolint:lll
			input: `npx -y @azure/static-web-apps-cli@1.1.1 deploy --tenant-id abc-123 --subscription-id abc-123 --resource-group r --app-name app-name --app-location / --output-location . --env default --no-use-keychain --deployment-token abc-123`,
			// nolint:lll
			expected: `npx -y @azure/static-web-apps-cli@1.1.1 deploy --tenant-id abc-123 --subscription-id abc-123 --resource-group r --app-name app-name --app-location / --output-location . --env default --no-use-keychain --deployment-token <redacted>`},
