...
func (rm *AzureResourceManager) GetDefaultResourceGroups(
	...
	matchingGroups := []azapi.AzCliResource{}
...
func (rm *AzureResourceManager) getWebAppResourceTypeDisplayName(
	...
	resource, err := rm.resourceService.GetResource(ctx, subscriptionId, resourceId, cWebAppApiVersion)
...
func (rm *AzureResourceManager) appendDeploymentResourcesRecursive(
	...
	operations, err := rm.deploymentService.ListResourceGroupDeploymentOperations(
