...
type Scope interface {
	...
	GetDeployment(ctx context.Context) (armresources.DeploymentsClientGetAtSubscriptionScopeResponse, error)
...
// GetDeployment fetches the result of the most recent deployment.
func (s *ResourceGroupScope) GetDeployment(ctx context.Context) (armresources.DeploymentsClientGetAtSubscriptionScopeResponse, error) {
	return armresources.DeploymentsClientGetAtSubscriptionScopeResponse{}, nil
}
...
// GetDeployment fetches the result of the most recent deployment.
func (s *SubscriptionScope) GetDeployment(ctx context.Context) (armresources.DeploymentsClientGetAtSubscriptionScopeResponse, error) {
