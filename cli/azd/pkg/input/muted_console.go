...
func NewMutedConsole(basedConsole Console) Console {
	return &mutedConsole{
...
func (sc *mutedConsole) ShowSpinner(ctx context.Context, title string, format SpinnerUxType) {
	log.Printf("request to show spinner on silent console with message: %s", title)
}

func (sc *mutedConsole) StopSpinner(ctx context.Context, lastMessage string, format SpinnerUxType) {
...
func (sc *mutedConsole) Prompt(ctx context.Context, options ConsoleOptions) (string, error) {
	return sc.parentConsole.Prompt(ctx, options)
}

// Use parent console for input
func (sc *mutedConsole) Select(ctx context.Context, options ConsoleOptions) (int, error) {
	return sc.parentConsole.Select(ctx, options)
}

// Use parent console for input
func (sc *mutedConsole) Confirm(ctx context.Context, options ConsoleOptions) (bool, error) {
...
func (sc *mutedConsole) Handles() ConsoleHandles {
