...
func (ch *ContainerHelper) GeneratedImage(
	...
	if parsedImage.Registry == "" {
		...
		configuredRegistry, err := RegistryName(ctx, ch.env, serviceConfig)
		if err == nil {
...
func (ch *ContainerHelper) RemoteImageTag(
	...
	registryName, err := RegistryName(ctx, ch.env, serviceConfig)
	if err != nil {
		return "", err
	}
...
func (ch *ContainerHelper) Credentials(
	...
	loginServer, err := RegistryName(ctx, ch.env, serviceConfig)
	if err != nil {
		return nil, err
	}
