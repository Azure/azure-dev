...
func Test_NewSwaProject(t *testing.T) {
...
func Test_NewSwaProjectAsFrameworkService(t *testing.T) {
	env := environment.NewWithValues("test-env", nil)
	inner := NewNoOpProject(env)
...
func Test_swaProject_Requirements(t *testing.T) {
	env := environment.NewWithValues("test-env", nil)
	inner := NewNoOpProject(env)
...
func Test_swaProject_RequiredExternalTools(t *testing.T) {
	env := environment.NewWithValues("test-env", nil)
	inner := NewNoOpProject(env)
	p := NewSwaProject(env, nil, nil, nil, inner)
...
func Test_swaProject_Initialize(t *testing.T) {
	env := environment.NewWithValues("test-env", nil)
	inner := NewNoOpProject(env)
	p := NewSwaProject(env, nil, nil, nil, inner)
...
func Test_swaProject_SetSource(t *testing.T) {
	env := environment.NewWithValues("test-env", nil)
	inner := NewNoOpProject(env)
	p := NewSwaProject(env, nil, nil, nil, inner)
...
func Test_swaProject_Restore(t *testing.T) {
	env := environment.NewWithValues("test-env", nil)
	inner := NewNoOpProject(env)
	p := NewSwaProject(env, nil, nil, nil, inner)
...
func Test_swaProject_Package(t *testing.T) {
	env := environment.NewWithValues("test-env", nil)
	inner := NewNoOpProject(env)
	p := NewSwaProject(env, nil, nil, nil, inner)
