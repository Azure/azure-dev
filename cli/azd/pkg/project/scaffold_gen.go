...
func infraFsForProject(ctx context.Context, prjConfig *ProjectConfig) (fs.FS, error) {
	...
	if infraDir != nil && fi == nil { // if the infra directory is not managed by azd, generate it to infra/app
		infraPrefix = filepath.Join(infraPrefix, "app")
	}
	...
	if fi == nil {
		...
		err = generatedFS.WriteFile(filepath.Join(infraPrefix, ".azd"), []byte(
			"// This file is automatically generated by azd for purposes of `azd infra synth`.\n"+
				"// This file can be removed when taking full control of the generated files.",
