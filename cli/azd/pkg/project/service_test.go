...
func (st *mockServiceTarget) Deploy(_ context.Context, _ *azd_context.AzdContext, _ string, progress chan<- string) (ServiceDeploymentResult, error) {
...
func TestDeployProgressMessages(t *testing.T) {
	...
	azdContext, _ := azd_context.NewAzdContext()
