...
def create_or_update_environment(subscription_id, resource_group, workspace_name, flow_path, flow_name):
    credential = AzureDeveloperCliCredential()
    # Check if given credential can get token successfully.
    credential.get_token("https://management.azure.com/.default")
    
    AIClient(credential, subscription_id, resource_group_id, )
