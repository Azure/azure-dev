...
resource functions 'Microsoft.Web/sites@2023-12-01' = {
  ...
  tags: union(tags, { 'azd-service-name': 'gofunc' })
  properties: {
...
// Storage Blob Data Contributor role for the function app's managed identity
...
// Storage Account Contributor role for the function app to manage deployment blobs
resource storageAccountContributor 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid(storage.id, functions.id, subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '17d1049b-9a84-46fb-8f53-869881c3d3ab'))
  properties: {
    principalId: functions.identity.principalId
