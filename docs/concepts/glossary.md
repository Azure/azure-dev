...
Client-side validation that runs after Bicep compilation but before deployment. Validates role assignment permissions and AI model quotas to surface issues early.
