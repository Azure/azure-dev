...
Emitted at provision start by the `microsoft.foundry` provisioning provider
in the `azure.ai.projects` extension to measure secured-agent adoption and
the BYO-vs-managed split.
