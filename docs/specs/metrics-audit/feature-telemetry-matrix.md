...
| **Execution environment resource** | Every azd invocation | All spans | `execution.environment` (bounded enum with optional fixed modifiers) | Identifies desktop, IDE, CI/CD, and coding-agent execution contexts; values are defined in `telemetry-schema.md` |
