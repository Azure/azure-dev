...
- [[#2448]](https://github.com/Azure/azure-dev/pull/2448) Services can be added to `azure.yaml` by holding `Shift` and dragging and dropping the folder into `azure.yaml`.
