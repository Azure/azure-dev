...
namespace Todo.Api
{
    public static class TodoEndpointsExt
    {
        ...
        public static async Task<IResult> GetList(ListsRepository _repository, Guid list_id)
        {
        ...
        public static async Task<IResult> UpdateList(ListsRepository _repository, Guid list_id, CreateUpdateTodoList list)
        {
        ...
        public static async Task<IResult> DeleteList(ListsRepository _repository, Guid list_id)
        {
        ...
        public static async Task<IResult> GetListItems(ListsRepository _repository, Guid list_id, int? skip = null, int? batchSize = null)
        {
            if (await _repository.GetListAsync(list_id) == null)
            {
                return TypedResults.NotFound();
        ...
        public static async Task<IResult> CreateListItem(ListsRepository _repository, Guid list_id, CreateUpdateTodoItem item)
        {
            if (await _repository.GetListAsync(list_id) == null)
            {
                return TypedResults.NotFound();
            ...
            return TypedResults.CreatedAtRoute($"/lists/{list_id}/items", newItem);
        }

        public static async Task<IResult> GetListItem(ListsRepository _repository, Guid list_id, Guid item_id)
        {
            if (await _repository.GetListAsync(list_id) == null)
            {
                return TypedResults.NotFound();
        ...
        public static async Task<IResult> UpdateListItem(ListsRepository _repository, Guid list_id, Guid item_id, CreateUpdateTodoItem item)
        {
        ...
        public static async Task<IResult> DeleteListItem(ListsRepository _repository, Guid list_id, Guid item_id)
        {
        ...
        public static async Task<IResult> GetListItemsByState(ListsRepository _repository, Guid list_id, string state, int? skip = null, int? batchSize = null)
        {
            if (await _repository.GetListAsync(list_id) == null)
            {
                return TypedResults.NotFound();
