...
public interface ItemsApi {
	 ...
	 */
	@Operation(operationId = "deleteItemById", summary = "Deletes a Todo item by unique identifier", tags = { "Items" },
			responses = { @ApiResponse(responseCode = "204", description = "Todo item deleted successfully"),
	...
	default ResponseEntity<Void> deleteItemById(
			@Parameter(name = "listId", description = "The Todo list unique identifier",
					required = true) @PathVariable("listId") String listId,
			@Parameter(name = "itemId", description = "The Todo item unique identifier",
					required = true) @PathVariable("itemId") String itemId) {
		return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
	 ...
	 * code 404)
	 */
	@Operation(operationId = "getItemById", summary = "Gets a Todo item by unique identifier", tags = { "Items" },
			responses = {
					@ApiResponse(responseCode = "200", description = "A Todo item result",
							content = { @Content(mediaType = "application/json",
									schema = @Schema(implementation = TodoItem.class)) }),
					@ApiResponse(responseCode = "404", description = "Todo list or item not found") })
	 ...
	 * code 404)
	 */
	@Operation(operationId = "getItemsByListId", summary = "Gets Todo items within the specified list",
			tags = { "Items" },
			responses = {
					@ApiResponse(responseCode = "200", description = "An array of Todo items",
							content = { @Content(mediaType = "application/json",
									schema = @Schema(implementation = TodoItem.class)) }),
					@ApiResponse(responseCode = "404", description = "Todo list not found") })
	...
	default ResponseEntity<List<TodoItem>> getItemsByListId(
			@Parameter(name = "listId", description = "The Todo list unique identifier",
					required = true) @PathVariable("listId") String listId,
			@Parameter(name = "top",
					description = "The max number of items to returns in a result") @Valid @RequestParam(value = "top",
							required = false, defaultValue = "20") BigDecimal top,
			@Parameter(name = "skip",
					description = "The number of items to skip within the results") @Valid @RequestParam(value = "skip",
							required = false, defaultValue = "0") BigDecimal skip) {
		getRequest().ifPresent(request -> {
			for (MediaType mediaType : MediaType.parseMediaTypes(request.getHeader("Accept"))) {
				if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
					String exampleString = "{ \"listId\" : \"listId\", \"dueDate\" : \"2000-01-23T04:56:07.000+00:00\", \"name\" : \"name\", \"description\" : \"description\", \"id\" : \"id\", \"completedDate\" : \"2000-01-23T04:56:07.000+00:00\" }";
	 ...
	 * (status code 404)
	 */
	@Operation(operationId = "getItemsByListIdAndState", summary = "Gets a list of Todo items of a specific state",
			tags = { "Items" },
			responses = {
					@ApiResponse(responseCode = "200", description = "An array of Todo items",
							content = { @Content(mediaType = "application/json",
									schema = @Schema(implementation = TodoItem.class)) }),
					@ApiResponse(responseCode = "404", description = "Todo list or item not found") })
	@RequestMapping(method = RequestMethod.GET, value = "/lists/{listId}/items/state/{state}",
			produces = { "application/json" })
	default ResponseEntity<List<TodoItem>> getItemsByListIdAndState(
			@Parameter(name = "listId", description = "The Todo list unique identifier",
					required = true) @PathVariable("listId") String listId,
			@Parameter(name = "state", description = "The Todo item state",
					required = true) @PathVariable("state") TodoState state,
			@Parameter(name = "top",
					description = "The max number of items to returns in a result") @Valid @RequestParam(value = "top",
							required = false, defaultValue = "20") BigDecimal top,
			@Parameter(name = "skip",
	 ...
	 */
	@Operation(operationId = "updateItemById", summary = "Updates a Todo item by unique identifier", tags = { "Items" },
			responses = {
					@ApiResponse(responseCode = "200", description = "A Todo item result",
							content = { @Content(mediaType = "application/json",
									schema = @Schema(implementation = TodoItem.class)) }),
	 ...
	 * code 400)
	 */
	@Operation(operationId = "updateItemsStateByListId", summary = "Changes the state of the specified list items",
			tags = { "Items" },
			responses = { @ApiResponse(responseCode = "204", description = "Todo items updated"),
					@ApiResponse(responseCode = "400", description = "Update request is invalid") })
	@RequestMapping(method = RequestMethod.PUT, value = "/lists/{listId}/items/state/{state}",
			consumes = { "application/json" })
	default ResponseEntity<Void> updateItemsStateByListId(
			...
			@Parameter(name = "request_body",
					description = "unique identifiers of the Todo items to update") @Valid @RequestBody(
							required = false) List<String> requestBody) {
		return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
