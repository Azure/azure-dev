...
public interface ListsApi {
	 ...
	 * 400)
	 */
	@Operation(operationId = "createList", summary = "Creates a new Todo list", tags = { "Lists" },
			responses = {
					@ApiResponse(responseCode = "201", description = "A Todo list result",
							content = { @Content(mediaType = "application/json",
									schema = @Schema(implementation = TodoList.class)) }),
					@ApiResponse(responseCode = "400", description = "Invalid request schema") })
	@RequestMapping(method = RequestMethod.POST, value = "/lists", produces = { "application/json" },
			consumes = { "application/json" })
	default ResponseEntity<TodoList> createList(@Parameter(name = "TodoList",
			description = "The Todo List") @Valid @RequestBody(required = false) TodoList todoList) {
	 ...
	 * (status code 404)
	 */
	@Operation(operationId = "deleteListById", summary = "Deletes a Todo list by unique identifier", tags = { "Lists" },
			responses = { @ApiResponse(responseCode = "204", description = "Todo list deleted successfully"),
	...
	default ResponseEntity<Void> deleteListById(@Parameter(name = "listId",
			description = "The Todo list unique identifier", required = true) @PathVariable("listId") String listId) {
		return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
	 ...
	 * 404)
	 */
	@Operation(operationId = "getListById", summary = "Gets a Todo list by unique identifier", tags = { "Lists" },
			responses = {
					@ApiResponse(responseCode = "200", description = "A Todo list result",
							content = { @Content(mediaType = "application/json",
									schema = @Schema(implementation = TodoList.class)) }),
					@ApiResponse(responseCode = "404", description = "Todo list not found") })
	@RequestMapping(method = RequestMethod.GET, value = "/lists/{listId}", produces = { "application/json" })
	default ResponseEntity<TodoList> getListById(@Parameter(name = "listId",
			description = "The Todo list unique identifier", required = true) @PathVariable("listId") String listId) {
		getRequest().ifPresent(request -> {
			for (MediaType mediaType : MediaType.parseMediaTypes(request.getHeader("Accept"))) {
				if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
	 ...
	 */
	@Operation(operationId = "getLists", summary = "Gets an array of Todo lists", tags = { "Lists" },
			responses = { @ApiResponse(responseCode = "200", description = "An array of Todo lists",
					content = { @Content(mediaType = "application/json",
							schema = @Schema(implementation = TodoList.class)) }) })
	 ...
	 */
	@Operation(operationId = "updateListById", summary = "Updates a Todo list by unique identifier", tags = { "Lists" },
			responses = {
					@ApiResponse(responseCode = "200", description = "A Todo list result",
							content = { @Content(mediaType = "application/json",
									schema = @Schema(implementation = TodoList.class)) }),
	...
	@RequestMapping(method = RequestMethod.PUT, value = "/lists/{listId}", produces = { "application/json" },
			consumes = { "application/json" })
