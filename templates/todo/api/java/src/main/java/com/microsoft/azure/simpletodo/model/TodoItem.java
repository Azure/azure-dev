...
public class TodoItem {
	...
	public boolean equals(final Object o) {
		...
		if (!((Object) this instanceof TodoItem))
			return false;
	...
	public String toString() {
		return "TodoItem(id=" + this.getId() + ", listId=" + this.getListId() + ", name=" + this.getName()
				+ ", description=" + this.getDescription() + ", state=" + this.getState() + ", dueDate="
				+ this.getDueDate() + ", completedDate=" + this.getCompletedDate() + ")";
	}
