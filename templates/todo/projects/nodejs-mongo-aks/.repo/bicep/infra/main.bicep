...
@description('The AKS cluser username')
param clusterAdminUsername string = 'aksadminuser'

@secure()
@description('The AKS cluser RSA public key')
...
module resources 'resources.bicep' = {
  ...
  params: {
    ...
    clusterAdminRsaPublicKey: clusterAdminRsaPublicKey
    tags: tags
  }
}
...
output AZURE_AKS_CONTROL_PLANE_FQDN string = resources.outputs.AZURE_AKS_CONTROL_PLANE_FQDN
