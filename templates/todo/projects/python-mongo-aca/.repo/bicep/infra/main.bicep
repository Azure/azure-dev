    ...
    apis: [
      {
        ...
        policies: [
          {
            value: replace(loadTextContent('../../../../../../common/infra/shared/gateway/apim/apim-api-policy.xml'), '{origin}', 'https://${web.outputs.fqdn}')
            format: 'rawxml'
          }
        ]
      }
...
output REACT_APP_WEB_BASE_URL string = 'https://${web.outputs.fqdn}'
